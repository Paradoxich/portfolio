...
export const colorUtilityTokens = [
  ...
  { token: "color.bg.graphic.muted",mapsTo: "color-graphic-muted (theme primitive)",                                       role: "Decorative graphic fills (dots/highlights)",                warm: "#606655", cool: "#757575", light: "#FFFFFF" },
  ...
  { token: "color.cta.primary",        mapsTo: "color-cta-primary → color-accent-70",          role: "Primary CTA background (Explore Projects, key pills)",       warm: "#EEC643", cool: "#EEC643", light: "#EEC643" },
  { token: "color.cta.primary.hover",  mapsTo: "color-cta-primary-hover → color-accent-60",    role: "Hover background for primary CTA",                           warm: "#DBB537", cool: "#DBB537", light: "#DBB537" },
];
