...
const PROJECTS: ProjectItem[] = [
  { name: "Neptune", tech: "Brand, LP · Concept, UX, UI", year: "2025" },
  { name: "MixLodge", tech: "LP/MVP · Concept, UX, UI", year: "2025" },
  { name: "Shuttle Console", tech: "Web platform · Concept, UX, UI", year: "2025" },
  { name: "Dealio", tech: "Mobile App, Web platform, LP · Concept, UX, UI", year: "2024" },
  { name: "Shuttle Console Beta", tech: "Web platform · Concept, UX, UI", year: "2023" },
  { name: "Worldcoin", tech: "Marketing · Illustration", year: "2023" },
  { name: "Shuttle", tech: "LP · Concept, UX, UI", year: "2022" },
  { name: "OptimoRoute", tech: "Web platform, Mobile app, Brand · Design Direction, UX, UI", year: "2022" },
  { name: "CoreData", tech: "LP · UX, UI, Illustration", year: "2021" },
  { name: "Five Agency", tech: "Brand · Illustration", year: "2020" },
  { name: "Marriott (Grow Game)", tech: "Mobile App · Concept, UX, UI, Illustration", year: "2020" },
  { name: "Penguin Random House (Ahab)", tech: "Web platform · Concept, UX, UI", year: "2020" },
  { name: "Marriott (TakeCare 30)", tech: "Mobile App · Concept, UX, UI", year: "2020" },
  { name: "Penguin Random House (Volumes)", tech: "Mobile App · UX, UI", year: "2019" },
  { name: "SurveySwap", tech: "Animated Explainer · Illustration", year: "2019" },
  { name: "Novo Protocol", tech: "Animated Explainer · Illustration", year: "2019" },
  { name: "Hewlett-Packard (Aruba Atmosphere)", tech: "Mobile App · Concept, UX, UI", year: "2018" },
  { name: "Megatrend IBM", tech: "Animated Explainer · Illustration", year: "2017" },
  { name: "Cirtuo", tech: "Web, Animated Explainer · UX, UI, Illustration", year: "2017" },
  { name: "Medulin Craft Beer Festival", tech: "Web, Brand · UX, UI, Illustration", year: "2016" },
  { name: "PPHE Hotel Group", tech: "Newsletter · Design", year: "2016" },
];
